...
export default store;
    ...
    * basiclly - your store is the go between for your app - it can take in actions and feed reducers with initial state and the action and recieve updated state which it then feeds to components
